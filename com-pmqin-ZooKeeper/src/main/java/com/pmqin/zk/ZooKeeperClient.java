...
public class ZooKeeperClient {
	...
	public static void main(String[] args) throws Exception {
       ...
       //如果遇到不能链接ConnectionLoss 看看是不是防火墙的问题 
		...
		System.out.println("“/RootNode”节点状态：" + zooKeeper.exists("/RootNode", true));// 判断指定目录节点是否存在,并设置是否Watch这个ZNode
		System.out.println("“RootNode”节点上数据：" + new String(zooKeeper.getData("/RootNode", true, null)));// 获取“RootNode”节点上的数据
		zooKeeper.create("/RootNode/ChildNode1", "ChildNode1Data".getBytes(), Ids.OPEN_ACL_UNSAFE,
				CreateMode.PERSISTENT);// 在“RootNode”节点下创建一个名为“ChildNode1”的子目录节点
		zooKeeper.create("/RootNode/ChildNode2", "ChildNode2Data".getBytes(), Ids.OPEN_ACL_UNSAFE,
				CreateMode.PERSISTENT);// 在“RootNode”节点下创建一个和“ChildNode1”同级的名为“ChildNode2”的子目录节点
