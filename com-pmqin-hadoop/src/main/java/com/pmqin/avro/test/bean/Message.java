...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1557542810402018222L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"com.pmqin.avro.test.bean\",\"fields\":[{\"name\":\"to\",\"type\":\"string\"},{\"name\":\"from\",\"type\":\"string\"},{\"name\":\"body\",\"type\":\"string\"}]}");
   ...
   */
  public static com.pmqin.avro.test.bean.Message.Builder newBuilder() {
    return new com.pmqin.avro.test.bean.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.pmqin.avro.test.bean.Message.Builder newBuilder(com.pmqin.avro.test.bean.Message.Builder other) {
    return new com.pmqin.avro.test.bean.Message.Builder(other);
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.pmqin.avro.test.bean.Message.Builder newBuilder(com.pmqin.avro.test.bean.Message other) {
    return new com.pmqin.avro.test.bean.Message.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
    ...
    private Builder() {
      super(com.pmqin.avro.test.bean.Message.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pmqin.avro.test.bean.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pmqin.avro.test.bean.Message other) {
            super(com.pmqin.avro.test.bean.Message.SCHEMA$);
      if (isValidValue(fields()[0], other.to)) {
        this.to = data().deepCopy(fields()[0].schema(), other.to);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pmqin.avro.test.bean.Message.Builder setTo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pmqin.avro.test.bean.Message.Builder clearTo() {
      to = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pmqin.avro.test.bean.Message.Builder setFrom(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pmqin.avro.test.bean.Message.Builder clearFrom() {
      from = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pmqin.avro.test.bean.Message.Builder setBody(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pmqin.avro.test.bean.Message.Builder clearBody() {
      body = null;
